...
- **Pasos para reproducir**:
  ...
  2. Acceder al detalle de cualquier producto.
...
- **Descripción**: La app mobile no cuenta con funcionalidad de búsqueda por voz nativa en la barra de búsqueda.
- **Pasos para reproducir**:
  1. En la app mobile, abrir la barra de búsqueda.
  2. Buscar el ícono de micrófono para búsqueda por voz.
- **Evidencia**: [Captura de pantalla](https://drive.google.com/file/d/1RYfEXPKPuCdzbDmPTD71aFkniKkgUPNd/view?usp=drive_link)
- **Plataforma afectada**: App Android (Motorola One Fusion - Android 11)

## Resumen
- **Total de incidencias reportadas**: 3
- **Severidad**: 1 Media, 2 Baja
- **Área principal afectada**: App Mobile
